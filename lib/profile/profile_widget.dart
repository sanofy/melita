        ...
        body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(24.0, 18.0, 24.0, 8.0),
                child: InkWell(
                  splashColor: Colors.transparent,
                  focusColor: Colors.transparent,
                  hoverColor: Colors.transparent,
                                        ...
                                        text: TextSpan(
                                          children: [
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'ox16tx59' /* Your daily goals almost done! */,
                                              ),
                                              style: const TextStyle(),
                                            ),
                                            const TextSpan(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    text: TextSpan(
                                      children: [
                                        TextSpan(
                                          text: FFLocalizations.of(context)
                                              .getText(
                                            'c5w1gl5x' /* Update personal information */,
                                          ),
                                          style: const TextStyle(),
                                        ),
                                        const TextSpan(
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'klz1e8mx' /* Manage your account and prefer... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        'rehv86xk' /* Change or reset your Melita pa... */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    ...
                                    child: Text(
                                      FFLocalizations.of(context).getText(
                                        '9pww69h8' /* Need help? Get support here */,
                                      ),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                          .override(
              ...
              Padding(
                padding: const EdgeInsetsDirectional.fromSTEB(25.0, 16.0, 24.0, 0.0),
                child: FFButtonWidget(
                  ...
                  options: FFButtonOptions(
                    ...
                    textStyle: FlutterFlowTheme.of(context).bodyLarge.override(
                          fontFamily: 'Outfit',
                          color: const Color(0xFFAD4249),
                          letterSpacing: 0.0,
                        ),
                    elevation: 0.0,
                    borderSide: const BorderSide(
                      color: Color(0xFFAD4249),
                      width: 1.0,
                    ),
