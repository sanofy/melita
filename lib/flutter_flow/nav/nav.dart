...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'Routines',
          path: '/routines',
          builder: (context, params) => const RoutinesWidget(),
        ),
        FFRoute(
          name: 'addRoutines2',
          path: '/addRoutines2',
          builder: (context, params) => const AddRoutines2Widget(),
        ),
        FFRoute(
          name: 'addRoutine1',
          path: '/addRoutine1',
          builder: (context, params) => const AddRoutine1Widget(),
        ),
        FFRoute(
          name: 'melitaAIWorking',
          path: '/melitaAIWorking',
          builder: (context, params) => const MelitaAIWorkingWidget(),
        ),
        FFRoute(
          name: 'RoutineSingle',
          path: '/routineSingle',
          builder: (context, params) => const RoutineSingleWidget(),
        ),
        FFRoute(
          name: 'Profile',
          path: '/profile',
